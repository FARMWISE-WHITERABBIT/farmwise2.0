    ...
    <div className="space-y-6">
        ...
        <Card className="border-[#39B54A] bg-[rgba(57,181,74,0.05)] rounded-[15px]">
          <CardContent className="flex items-center justify-between py-4">
            ...
            <Button asChild className="bg-[#39B54A] hover:bg-[#2d8f3a]">
              <Link href={`/dashboard/farmers/${params.id}/create-account`}>Create Account</Link>
            </Button>
          </CardContent>
        </Card>
      )}
      ...
      <Tabs defaultValue="overview" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {farmer.secondary_phone && (
                  <div className="flex items-start gap-3">
                    <Phone className="h-5 w-5 text-[#39B54A] mt-0.5" />
                    <div>
                      <p className="text-xs text-[rgba(0,0,0,0.45)] font-inter">Secondary Phone</p>
                      <p className="text-sm font-medium font-inter">{farmer.secondary_phone}</p>
                    </div>
                  </div>
                )}
                {farmer.email && (
        ...
        <TabsContent value="finance" className="space-y-6">
          <FarmerFinanceSection farmerId={params.id} financialSummary={financialSummary} />
        </TabsContent>
        ...
        <TabsContent value="plots" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" className="bg-[#39B54A] hover:bg-[#2d8f3a]">
              <Map className="h-4 w-4 mr-2" />
              Add Plot
            </Button>
          </div>
