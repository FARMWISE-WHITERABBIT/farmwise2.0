...
export function UserRegistrationForm({
  ...
  useEffect(() => {
    if (formData.state && NIGERIAN_STATES_LGAS[formData.state]) {
      setAvailableLGAs(NIGERIAN_STATES_LGAS[formData.state])
      if (formData.lga && !NIGERIAN_STATES_LGAS[formData.state].includes(formData.lga)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("[v0] Submitting user registration:", formData)
      ...
      console.log("[v0] User registration response:", result)
      ...
      toast({
        title: "Success",
        description: result.message || "User created successfully. A password reset link has been sent to their email.",
      })
  ...
  const roleOptions =
    currentUserRole === "super_admin"
      ? [
          { value: "admin", label: "Admin - Full access including loan management" },
          { value: "manager", label: "Manager - Can edit farmers and view data" },
          { value: "viewer", label: "Viewer - Can only view data" },
          { value: "field_agent", label: "Extension Agent - Manage farmers and activities" },
          { value: "analyst", label: "Analyst - View analytics and reports" },
        ]
      : [
          { value: "admin", label: "Admin - Full access including loan management" },
          { value: "manager", label: "Manager - Can edit farmers and view data" },
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <Card className="rounded-[25px] border-0 shadow-sm max-w-2xl bg-card">
        <CardHeader>
          <CardTitle className="font-poppins text-xl">User Information</CardTitle>
          <CardDescription className="font-inter">Enter the details of the new user</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  {Object.keys(NIGERIAN_STATES_LGAS)
                    .sort()
                    .map((state) => (
          ...
          <div className="space-y-2">
            <div className="p-4 bg-primary-light rounded-[10px] border border-border">
              <p className="text-sm text-foreground font-inter">
                <strong>Note:</strong> A temporary password will be automatically generated and a password reset link
                will be sent to the user's email. They will be required to set their own password on first login.
              </p>
            </div>
          </div>
